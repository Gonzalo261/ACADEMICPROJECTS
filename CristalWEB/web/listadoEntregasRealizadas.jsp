    ...
    <body>
        <center><br>
            <div class="container fluid-5"> 
                <div class="row">
                    <div class="col-4">
                    <h4 align="left">Lista de pedidos Entregados</h4>
                                </div> 
                        <div class="col-8"> 
                    ...
                    <div class="row">
                        ...
                        <table class="table table-hover table-active table-secondary">
                            ...
                            <c:choose>
                                        <c:when test="${not empty entregasRealizadas}">  
                            <c:forEach items="${ entregasRealizadas }" var="item">
                                        <tr>
                                            <td>${ item.fechaYHoraEntrega } </td>
                                            <td> ${ item.DTOContrato.DTOPresupuesto.lugarEntrega }</td>
    ...
    <script>
        function filtrar(num)
        {
            if(num===1)
            {
                ...
                window.location = "Entregas?modo=entregasRealizadasFiltro&fechaA="+ fechaA+"&fechaB="+ fechaB; 
            }
            else if(num===2) window.location = "Entregas?modo=entregasRealizadasAnual";   
        }
